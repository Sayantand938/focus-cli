...
//   .transform(parseTimeStringToDate);
...
//   static flags = {
//     start_time: Flags.string({ description: 'New start time in HH:MM AM/PM format', exclusive: ['date'] }),
//     stop_time: Flags.string({ description: 'New stop time in HH:MM AM/PM format', exclusive: ['date'] }),
//     date: Flags.string({ description: 'New date in yyyy-MM-dd format' }),
//   };

//   private db = new FocusDatabase();
...
//     if (flags.date) {
//       result.date = dateSchema.parse(flags.date);
//     }
//     if (flags.start_time) {
//       result.startTime = timeSchema.parse(flags.start_time);
//     }
//     if (flags.stop_time) {
//       result.stopTime = timeSchema.parse(flags.stop_time);
//     }
